              ...
              <tbody>
                    <tr>
                        <% Connection cx=ConexPuntos.getConex();
                           PreparedStatement ps=cx.prepareStatement("select b.NOM_EQUIP,a.PJ,a.PG,a.PE,a.PP,a.GF,a.GC,a.DG,a.PUNTAJE from resultado a, equipo b, grupos c, TORNEO D, categoria e where a.ID_EQUIP = b.ID_EQUIP and c.ID_TORNEO = D.ID_TORNEO and c.ID_GRUPO=b.ID_GRUPO and  D.ID_TORNEO=3 and e.NOM_CAT = 'Futbol' and c.NOM_GRUPO='A' order by a.PUNTAJE DESC");
