        ...
        <div style="width: 600px;">
         ...
         <div><table class="table table-bordered">
             ...
             <tr>   <th>Grupo D</th>
              ...
              <tbody>
                    <tr>
                        <% PreparedStatement ps3=cx.prepareStatement("select b.NOM_EQUIP,a.PJ,a.PG,a.PE,a.PP,a.GF,a.GC,a.DG,a.PUNTAJE from resultado a, equipo b, grupos c, TORNEO D, categoria e where a.ID_EQUIP = b.ID_EQUIP and c.ID_TORNEO = D.ID_TORNEO and c.ID_GRUPO=b.ID_GRUPO and  D.ID_TORNEO=2 and and e.NOM_CAT = 'Futbol' c.NOM_GRUPO='D' order by a.PUNTAJE DESC");
