            ...
            <section class="content">
                <div class="box">
                    ...
                    <div class="box-title" style="margin-left: 1%">
                        <br> <strong><h3 >Voleyball</h3 ></strong>
                    </div><!-- /.box-header -->
        ...
        function calcular_partidos() {
            if ($(".es_cronograma").val() == "1") {
                if (confirm("se perderán los datos ya calculados anteriormente, ¿desea volver a calcular?")) {
                    $.post("../../../programacion_partido", "opc=Nuevo_Calculo&id_torneo=TOR-00000000000001" + "" + "&id_cat_juego=CTJ-00000000000002" + "" + "&tipo_juego=" + $(".tipo_juego").val() + "&tiempo_juego=" + $(".tiempo_juego").val() + "&tiempo_espera=" + $(".tiempo_espera").val(), function (objJson) {
                        listar_cronograma_loza();
                    });
                }
            } else {
                $.post("../../../programacion_partido", "opc=Progamar_Juego&id_torneo=TOR-00000000000001" + "" + "&id_cat_juego=CTJ-00000000000002" + "" + "&tipo_juego=" + $(".tipo_juego").val(), function (objJson) {
                    listar_cronograma_loza();
                });
            }
        }
        function listar_cronograma_loza() {
            var d = "opc=ListarLozas_Horario&id_torneo=TOR-00000000000001" + "" + "&id_cat_juego=CTJ-00000000000002" + "" + "&tipo_juego=" + $(".tipo_juego").val();
            var texto = '';
